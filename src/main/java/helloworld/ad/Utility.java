...
public class Utility {
    private static final Version LUCENE_VERSION = Version.LUCENE_4_0;//TODO: what might be the problem?
    private static List<? extends Serializable> symbolStopWords = Arrays.asList('.', ',', '"', "'", '?', '!', ':', ';', '(', ')', '[', ']', '{', '}', '&','/', "...",'-','+','*','|',"),");
    private static CharArraySet symbolStopSet = new CharArraySet(Version.LUCENE_4_0, symbolStopWords,true);
    ...
    private static CharArraySet getStopwords(String stopwords) {
        ...
        return new CharArraySet(LUCENE_VERSION, stopwordsList, true);//TODO: bug
    }
    ...
    public static List<String> cleanedTokenize(String input){
        ...
        tokenStream = new StopFilter(LUCENE_VERSION, tokens, stopSet);
